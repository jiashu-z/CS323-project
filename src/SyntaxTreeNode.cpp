...
SyntaxTreeNode::SyntaxTreeNode(std::string attributeName, std::string attributeValue,
                               int firstLine, int firstColumn, TreeNodeType nodeType) : nodeType(nodeType),
                                                                                        attribute_name(std::move(
                                                                                                attributeName)),
                                                                                        attribute_value(std::move(
                                                                                                attributeValue)),
                                                                                        firstLine(firstLine),
...
SyntaxTreeNode::SyntaxTreeNode(std::string attributeName,
                               std::string attributeValue, int firstLine, TreeNodeType nodeType) : nodeType(nodeType),
                                                                                                   attribute_name(
                                                                                                           std::move(
                                                                                                                   attributeName)),
                                                                                                   attribute_value(
